-- CreateEnum
CREATE TYPE "ChainKind" AS ENUM ('ETHEREUM', 'BSC', 'POLYGON', 'ARBITRUM', 'OPTIMISM', 'BASE', 'AVALANCHE', 'FANTOM', 'GNOSIS', 'CRONOS', 'SOLANA', 'TRON', 'TON', 'NEAR', 'COSMOS', 'SUI', 'APTOS', 'STARKNET', 'BITCOIN', 'DOGE', 'LITECOIN', 'NATIVE', 'OTHER');
...
-- CreateIndex
CREATE INDEX "Coin_chainKind_idx" ON "Coin"("chainKind");

-- CreateIndex
CREATE INDEX "Coin_address_idx" ON "Coin"("address");

-- CreateIndex
CREATE UNIQUE INDEX "Coin_chainKind_address_key" ON "Coin"("chainKind", "address");
